...
Object.defineProperty(Entity, Symbol.hasInstance, { value(v: any) { return [Entity.prototype, Player.prototype, SimulatedPlayer.prototype].includes(Object.getPrototypeOf(v ?? {})) } })
Object.defineProperty(Player, Symbol.hasInstance, { value(v: any) { return [Player.prototype, SimulatedPlayer.prototype].includes(Object.getPrototypeOf(v ?? {})) } }) // unnecessary in 1.19.70

const renameProperties: [obj: any, replaces: [key: string, value: [get: string, set?: string] | string][]][] = [
    [
        Entity, [
...
for (const [obj, list] of renameProperties) {
    ...
    for (const [k, d] of list) {
        if (typeof d === 'string') {
            const o = cp[d] || cp[k]
            if (o) Object.defineProperty(obj.prototype, k, o)
        } else {
            ...
            if (s) desc.set = function(v) { return sv?.call(this, v) }
