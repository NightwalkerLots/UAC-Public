...
##The following are guilty of CBE, crashing, lag machines, and other behaviors not even anarchy realms would allow
##Proof of their actions was aquired before adding them here
...
tag "ThreeCypress755" add PermBan
tag "Solar hxney" add PermBan
tag "SilentStream303" add PermBan
tag "NLAB brook" add PermBan
tag "DividingHare956" add PermBan
tag "Wildanimal49" add PermBan
tag "NoE1837" add PermBan
tag "majorasxlinkVA" add PermBan
tag "NicktrosGaming" add PermBan
tag "Asatobyjg" add PermBan
tag "x_beast6464_xX" add PermBan
tag "MaddeBaddie" add PermBan
tag "Master24016724" add PermBan
tag "ChickenMan4238" add PermBan
tag "TwelveBasket552" add PermBan
tag "Plahsmuh4880" add PermBan
tag "Llamatron334" add PermBan
tag "F4rtFN" add PermBan
tag "PoisonSoap33984" add PermBan
tag "mv2a7610" add PermBan
tag "Stelthoextra" add PermBan
tag "bubby scout01" add PermBan
tag "Xd L3onZz" add PermBan
tag "TilledSea951173" add PermBan
tag "PrinceArctic497" add PermBan
tag "Matogamer64" add PermBan
tag "peanutfarmer718" add PermBan
tag "Thekuala123" add PermBan
tag "UniformKitty549" add PermBan
tag "VerySpy71098480" add PermBan
tag "UltraDino8562" add PermBan
tag "ZedOut9829" add PermBan
tag "Solar hxney" add PermBan
tag "ImASadEg" add PermBan
tag "NotEmmett8393" add PermBan
tag "tarou0302" add PermBan
tag "hakchu1" add PermBan
tag "o9zm" add PermBan
tag "RynkosSon" add PermBan
tag "Cl Part 0118" add PermBan
tag "RealmAlpha2" add PermBan
tag "RealmAlpha1" add PermBan
tag "NeverCordsYT" add PermBan
tag "RealmAlpha69" add PermBan
tag "RubenThePig3818" add PermBan
tag "MrDiamond643" add PermBan
tag "NotRandomYT" add PermBan
tag "Datboyjuju6blok" add PermBan
tag "Russak2245" add PermBan
tag "SummerHorse7634" add PermBan
tag "SnakyJaguar8906" add PermBan
tag "Hacker82" add PermBan
tag "L2 Madrab" add PermBan
tag "Adambombio" add PermBan
tag "WorldStudent50" add PermBan
tag "RNG 999" add PermBan
tag "TTVY79976" add PermBan
tag "Assassin3488870" add PermBan
tag "AakarshIs0P" add PermBan
tag "nickit1234" add PermBan
tag "Dr Dumpy1112" add PermBan
tag "Qxtz7415" add PermBan
tag "Highpower114" add PermBan
tag "UnknownMass405" add PermBan
tag "MohMoh1000" add PermBan
tag "ANdmes Alt" add PermBan
tag "GodGamer7991" add PermBan
tag "DreamE2125" add PermBan
tag "Kevin232744" add PermBan
tag "Anonymous3816" add PermBan
tag "AyoDevvan" add PermBan
tag "SparklyBrick157" add PermBan
tag "Axzche" add PermBan
tag "Xx VpXz xX" add PermBan
tag "HousingMaster" add PermBan
tag "jasonmaker" add PermBan
tag "FatterTub5718" add PermBan
tag "Sussy sus1753" add PermBan
tag "TANAKATAROU5713" add PermBan
tag "ShallowVermin33" add PermBan
tag "RacketyJeans909" add PermBan
tag "BITExTHExDUST" add PermBan
tag "Cedarbasilisk48" add PermBan
tag "lolGR9059" add PermBan
tag "suckfallen" add PermBan
tag "roboticikr" add PermBan
tag ReallyOscar add PermBan
tag myk4rill add PermBan
