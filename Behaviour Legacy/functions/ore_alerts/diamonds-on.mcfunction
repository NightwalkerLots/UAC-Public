...
execute @s[scores={mdmtoggle=1}] ~~~ execute @s[tag=staffstatus] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC STAFF §¶§b► §6Diamonds Alerts §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
