        ...
        if (sender.hasTag('staffstatus')) {
            if (args[0]) {
                ...
                if(add.includes(args[0])) {
                    ...
                    sender.runCommandAsync(`execute as "${playerfound.getName()}" at @s run function UAC/mayfly`); 
                    ...
                    sender.runCommandAsync(`execute as "${playerfound.getName()}" at @s run function UAC/mayflyremove`); 
                }
            } else {
