...
execute @s[tag=staffstatus,scores={unban=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §d"},{"selector":"@s"},{"text":" §bhas §2OPENED a §6Unban Window"}]}
...
execute @s[tag=staffstatus,scores={unban=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §d"},{"selector":"@s"},{"text":" §bhas §cCLOSED a §6Unban Window"}]}
