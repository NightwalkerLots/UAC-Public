...
execute @s[scores={lstcmd=41}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §d"},{"selector":"@s"},{"text":"'s §blast command was the §6function toggle/anticbe-off §bcommand"}]}
execute @s[scores={lstcmd=42}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §d"},{"selector":"@s"},{"text":"'s §blast command was the §6function toggle/anticbe-off §bcommand"}]}
execute @s[scores={lstcmd=43}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §d"},{"selector":"@s"},{"text":"'s §blast command was the §6function toggle/anticbe-off §bcommand"}]}
execute @s[scores={lstcmd=44}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §d"},{"selector":"@s"},{"text":"'s §blast command was the §6function toggle/anticbe-off §bcommand"}]}
execute @s[scores={lstcmd=45}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §d"},{"selector":"@s"},{"text":"'s §blast command was the §6function toggle/anticbe-off §bcommand"}]}
execute @s[scores={lstcmd=46}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §d"},{"selector":"@s"},{"text":"'s §blast command was the §6function toggle/anticbe-off §bcommand"}]}
execute @s[scores={lstcmd=47}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §d"},{"selector":"@s"},{"text":"'s §blast command was the §6function toggle/anticbe-off §bcommand"}]}
execute @s[scores={lstcmd=48}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §d"},{"selector":"@s"},{"text":"'s §blast command was the §6function toggle/anticbe-off §bcommand"}]}
