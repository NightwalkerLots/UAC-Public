...
#Placed Items bypass
execute @r[tag=!staffstatus,scores={uoimtoggle=1}] ~ ~ ~ execute @s[scores={bbmtoggle=0}] ~~~ fill ~8 ~5 ~8 ~-8 ~-5 ~-8 air 0 replace barrier
execute @r[tag=!staffstatus,scores={uoimtoggle=1}] ~ ~ ~ fill ~8 ~5 ~8 ~-8 ~-5 ~-8 air 0 replace bedrock
