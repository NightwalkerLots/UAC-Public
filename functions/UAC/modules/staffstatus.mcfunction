#Fake staff flag
execute @s[scores={ssmtoggle=1}] ~~~ execute @s[scores={I2IO2NO=0},tag=staffstatus] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cUAC ► §6Fake Staff Protection : §bFlagged §d"},{"selector":"@s"},{"text":"§¶§b for unauthorized staff tag."}]}
