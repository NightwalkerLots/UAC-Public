...
#Tempkick ("Edited By Catastrophe 5/24/2021 -> flycount makes sure anyone above the given value will be kicked/banned")execute @s[tag=!staffstatus,scores={flycount=120..}] ~~~ execute @s[scores={2KK001=0}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cUAC ► §d"},{"selector":"@s"},{"text":" §¶§cwas banned for fly hacks"}]}
execute @s[scores={afmtoggle=1,2KK001=0}] ~~~ kick @s[m=!c,tag=!staffstatus,scores={flycount=120}] §¶§cUAC §¶§b► Tempkicked for fly hacks
