...
execute @s[scores={mdmtoggle=1}] ~~~ execute @s[scores={goldmd=1}] ~~~ execute @s[scores={goldfnd=0}] ~~~ execute @e[type=item,name="raw gold",r=5] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §6Mining Detection §d"},{"selector":"@a[r=5]"},{"text":" §¶§bHas come across §6GOLD."}]}
execute @s[scores={mdmtoggle=1}] ~~~ execute @s[scores={goldmd=1}] ~~~ execute @s[scores={goldfnd=0}] ~~~ execute @e[type=item,name="gold nugget",r=5] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §6Mining Detection §d"},{"selector":"@a[r=5]"},{"text":" §¶§bHas come across §6Nether GOLD."}]}
...
execute @s[scores={mdmtoggle=1}] ~~~ execute @s[scores={scrapmd=1}] ~~~ execute @s[scores={scrapfnd=0}] ~~~ execute @e[type=item,name="ancient debris",r=5] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §6Mining Detection §d"},{"selector":"@a[r=5]"},{"text":" §¶§bHas come across §0NETHERITE SCRAP."}]}
execute @a[scores={mdmtoggle=1}] ~~~ execute @s[scores={ironmd=1}] ~~~ execute @s[scores={ironfnd=0}] ~~~ execute @e[type=item,name="raw iron",r=5] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §6Mining Detection §d"},{"selector":"@a[r=5]"},{"text":" §¶§bHas come across §8IRON."}]}
...
execute @s[scores={mdmtoggle=1}] ~~~ execute @s[scores={lapizmd=1}] ~~~ execute @e[type=item,name="Lapis Lazuli",r=5] ~~~ scoreboard players set @a[r=5] laepizfnd 1
