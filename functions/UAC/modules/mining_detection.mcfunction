...
execute @s[scores={mdmtoggle=1}] ~~~ execute @s[scores={ironmd=1}] ~~~ execute @s[scores={ironfnd=0}] ~~~ execute @e[type=item,name="raw iron",r=5] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §6Mining Detection §d"},{"selector":"@a[r=5]"},{"text":" §¶§bHas come across §8IRON."}]}
