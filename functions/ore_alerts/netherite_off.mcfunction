...
execute @s[scores={mdmtoggle=1}] ~~~ execute @s[tag=staffstatus] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Iron Alerts §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
