execute @s[tag=staffstatus,scores={wbmtoggle=1}] ~~~ scoreboard players set BDXdummy Border_Coord_X 50000
execute @s[tag=staffstatus,scores={wbmtoggle=1}] ~~~ scoreboard players set BDXdummy Border_Coord_Z 50000
...
execute @s[tag=staffstatus] ~~~ tellraw @a[tag=staffstatus,scores={wbmtoggle=1}] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6World Border §bhas been set to §250k §bby §d"},{"selector":"@s"}]}
