...
execute @s[tag=staffstatus,scores={ICM=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Item Commands §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
#turn off
...
execute @s[tag=staffstatus,scores={ICM=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Item Commands §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
