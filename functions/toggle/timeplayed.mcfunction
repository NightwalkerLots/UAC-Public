...
execute @s[tag=staffstatus,scores={TPM=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Time Played Tracker §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
#turn off
...
execute @s[tag=staffstatus,scores={TPM=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Time Played Tracker §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
