...
execute @s[tag=staffstatus,scores={IBM=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Custom Item Ban §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
#turn off
...
execute @s[tag=staffstatus,scores={IBM=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Custom Item Ban §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
