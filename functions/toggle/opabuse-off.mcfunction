execute @s[tag=staffstatus,name=nightwalkerlots] ~~~ scoreboard players set opamtoggledummy opamtoggle 0
execute @s[tag=staffstatus,name=nightwalkerlots] ~~~ scoreboard players operation @a opamtoggle = opamtoggledummy opamtoggle
execute @s[tag=staffstatus,name=nightwalkerlots] ~~~ scoreboard players set @a OPAM 0
...
execute @s[tag=staffstatus,name=nightwalkerlots] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Anti OP Abuse §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
