execute @s[tag=staffstatus,name=nightwalkerlots] ~~~ scoreboard players set ssmtoggledummy ssmtoggle 0
execute @s[tag=staffstatus,name=nightwalkerlots] ~~~ scoreboard players operation @a ssmtoggle = ssmtoggledummy ssmtoggle
execute @s[tag=staffstatus,name=nightwalkerlots] ~~~ scoreboard players set @a SSM 0
...
execute @s[tag=staffstatus,name=nightwalkerlots] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Fake Staff Protection §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
