...
#turn on
execute @s[tag=staffstatus,scores={dethtoggle=1}] ~~~ scoreboard scoreboard players set BDXdummy Deathef 1
execute @s[tag=staffstatus,scores={dethtoggle=1}] ~~~ scoreboard players operation @a Deathef = BDXdummy Deathef
execute @s[tag=staffstatus,scores={dethtoggle=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Anti-CBE §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
#turn off
execute @s[tag=staffstatus,scores={dethtoggle=2}] ~~~ scoreboard scoreboard players set BDXdummy Deathef 0
execute @s[tag=staffstatus,scores={dethtoggle=2}] ~~~ scoreboard players operation @a Deathef = BDXdummy Deathef
execute @s[tag=staffstatus,scores={dethtoggle=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Anti-CBE §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
