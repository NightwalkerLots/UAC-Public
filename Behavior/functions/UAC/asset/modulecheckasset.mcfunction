...
execute @s[tag=staffstatus,scores={armtoggle=1}] ~~~ tellraw @s {"rawtext":[{"text":"§¶§cUAC §¶§b►§¶§bAnti-Reach §7[ §¶§2ENABLED §7]"}]}
execute @s[tag=staffstatus,scores={armtoggle=0}] ~~~ tellraw @s {"rawtext":[{"text":"§¶§cUAC §¶§b►§¶§bAnti-Reach §7[ §¶§cDISABLED §7]"}]}
...
execute @s[tag=staffstatus,scores={WBM=1}] ~~~ tellraw @s {"rawtext":[{"text":"§¶§cUAC §¶§b►§¶§bWorld Border §7[ §¶§2ENABLED §7]"},{"text":" §bX§7: §7[§6"},{"score":{"name":"@s","objective":"Border_Coord_X"}},{"text":"§7]"},{"text":" §bZ§7: §7[§6"},{"score":{"name":"@s","objective":"Border_Coord_Z"}},{"text":"§7]"}]}
