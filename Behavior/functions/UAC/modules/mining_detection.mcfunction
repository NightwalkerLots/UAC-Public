...
execute @s[scores={mdmtoggle=1}] ~~~ execute @s[scores={scrapmd=1}] ~~~ execute @s[scores={scrapfnd=0}] ~~~ execute @e[type=item,name="ancient debris",r=5] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §b► §6Mining Detection §d"},{"selector":"@a[r=5]"},{"text":" §¶§bHas come across §dNETHERITE SCRAP."}]}
