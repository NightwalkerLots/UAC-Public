...
execute @s[tag=staffstatus,scores={ACM=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC STAFF §¶§b► §6Anti-CBE §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
...
execute @s[tag=staffstatus,scores={ACM=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC STAFF §¶§b► §6Anti-CBE §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
