...
execute @s[tag=staffstatus,scores={NEM=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6No Echest §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
#turn off
...
execute @s[tag=staffstatus,scores={NEM=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6No Echest §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
