...
execute @s[tag=staffstatus,scores={armtoggle=1,arm_gt_toggle=0,has_gt=0}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Anti-Reach §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}

#turn off
execute @s[tag=staffstatus,scores={armtoggle=2,has_gt=0}] ~~~ scoreboard players operation @a armtoggle = armtoggledummy armtoggle
execute @s[tag=staffstatus,scores={armtoggle=2,has_gt=0}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Anti-Reach §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
