...
execute @s[tag=staffstatus,scores={clmtoggle=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Anti-C Logging §bhas been toggled to §2KILL MODE §bby §d"},{"selector":"@s"}]}
...
execute @s[tag=staffstatus,scores={clmtoggle=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Anti-C Logging §bhas been toggled to §2CLEAR MODE §bby §d"},{"selector":"@s"}]}
...
execute @s[tag=staffstatus,scores={clmtoggle=3}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Anti-C Logging §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
