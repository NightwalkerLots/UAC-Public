...
execute @s[tag=staffstatus,scores={HMM=3}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Hotbar Message §bhas been set to §2Resource-Pack §bmode §bby §d"},{"selector":"@s"}]}
...
execute @s[tag=staffstatus,scores={HMM=4}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Hotbar Message §bhas been §cDISABLED §bby §d"},{"selector":"@s"}]}
