...
execute @s[tag=staffstatus,scores={LTM=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Auto Lag Clear §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
#turn off
...
execute @s[tag=staffstatus,scores={LTM=2}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Auto Lag Clear §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
