    ...
    try {
        ...
        if(item in SellableItems) {
            if(sender.hasitem(item, amount)) {
                ...
                sender.tellraw(`§¶§cUAC ► §bSold! You now have §c${sender.scoreTest('money')}$. §6Item §7: §c${item} §6Amount §7: §c${amount} §6Total Profit §7: §c${cost} §6 Sell Price Per Item §7: §c${price}`);
